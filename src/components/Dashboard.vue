    ...
    <div class="grid grid-cols-12 min-h-screen">
      <div class="col-span-2 bg-purple-light py-2 px-3">
        <div class="font-extrabold pb-4 pt-1">
          <h1 class="text-white text-center text-base">
            ORO LOUNGE
            <h2 class="text-white text-center text-xs">ADMIN</h2>
          </h1>
        </div>
        ...
        <a href="#" class>
          <svg
            ...
            class="h-6 w-6 inline-block pr-1 text-white"
            fill="none"
            viewBox="0 0 24 24"
            stroke="currentColor"
          >
          ...
          <h1 class="text-white text-sm inline-block py-4 font-extrabold">Dashboard</h1>
        </a>
        ...
        <ul class="text-gray-300 text-sm px-2">
          <li class="py-4 hover:text-white">
            <a href="#" class>
              <svg
                xmlns="http://www.w3.org/2000/svg"
